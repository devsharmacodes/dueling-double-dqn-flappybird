...
import itertools
import os
# above flappy bird game from gymnasium is imported form gymnasium 
'''also the gymnasium(gymnasium is a python library which provides the 
enviroment for rl agents for training and testing) is also imported''' 
...
device = 'cpu' # force cpu, sometimes GPU not always faster than CPU due to overhead of moving data to GP
...
if __name__ == '__main__':
    ...
    # # here were are making enviroment for our agent using .make method/function
    # env = gym.make("FlappyBird-v0", render_mode="human", use_lidar=False)


    # # here it resets the env
    # state, _ = env.reset()
    # while True:# this loop says that this condition will always be true and run untill break or intruption
    #     # env.action_space this gives how many action we have here and .sample is used to choose from them randomly
    #     action = env.action_space.sample()

    #     # here .step(action) is used to perform action on it and it return a tuple
